...
export function computeFoldingRanges(state) {
    const ranges = [];
...
function findBlockFolds(tokens, ranges, mapper) {
...
function addFoldRange(ranges, startToken, endToken, mapper) {
