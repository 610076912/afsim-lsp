...
export class WsfParser extends CstParser {
    ...
    // ========================================================================
    onInitializeBlock = this.RULE("onInitializeBlock", () => {
    ...
    onUpdateBlock = this.RULE("onUpdateBlock", () => {
    ...
    onEntryBlock = this.RULE("onEntryBlock", () => {
    ...
    onExitBlock = this.RULE("onExitBlock", () => {
    ...
    onMessageBlock = this.RULE("onMessageBlock", () => {
    ...
    onInitBlock = this.RULE("onInitBlock", () => {
    ...
    onTrackDropBlock = this.RULE("onTrackDropBlock", () => {
    ...
    onBingoBlock = this.RULE("onBingoBlock", () => {
    ...
    onEmptyBlock = this.RULE("onEmptyBlock", () => {
    ...
    onRefuelBlock = this.RULE("onRefuelBlock", () => {
    ...
    onReserveBlock = this.RULE("onReserveBlock", () => {
    ...
    onNewExecuteBlock = this.RULE("onNewExecuteBlock", () => {
    ...
    onNewFailBlock = this.RULE("onNewFailBlock", () => {
    ...
    // ========================================================================
    nextStateBlock = this.RULE("nextStateBlock", () => {
