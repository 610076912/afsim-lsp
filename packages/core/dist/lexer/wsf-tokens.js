...
// ---------------------------------------------------------------------------
function createWsfToken(name, regexStr, options) {
    return createToken({
        name,
...
export const WSF_END_KEYWORDS = new Set([
...
export const WSF_TOP_LEVEL_KEYWORDS = new Set([
...
//# sourceMappingURL=wsf-tokens.js.map