...
import { ScriptBlockEntry, ExecuteScriptEntry, ScriptHeuristicEscape, } from "./custom-matchers.js";
// ============================================================================
...
// ---------------------------------------------------------------------------
const scriptOperatorsAndPunctuation = [
...
let _lexerInstance = null;
export function createMultiModeLexer() {
    if (!_lexerInstance) {
...
//# sourceMappingURL=multi-mode-lexer.js.map