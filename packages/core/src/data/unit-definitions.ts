...
const _allUnits = new Set<string>();
...
export const ALL_UNIT_STRINGS: ReadonlySet<string> = _allUnits;

/**
 * Get all valid unit strings for completion suggestions.
 * Returns a flat array of all unit strings.
 */
export function getAllUnitStrings(): string[] {
 ...
 */
export function isValidUnit(s: string): boolean {
