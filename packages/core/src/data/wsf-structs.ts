...
export const WSF_SENSOR_TYPES: readonly WsfStructType[] = [
...
export const WSF_PROCESSOR_TYPES: readonly WsfStructType[] = [
...
export const WSF_MOVER_TYPES: readonly WsfStructType[] = [
...
export const WSF_COMM_TYPES: readonly WsfStructType[] = [
...
export const WSF_NETWORK_TYPES: readonly WsfStructType[] = [
...
export const WSF_FUEL_TYPES: readonly WsfStructType[] = [
...
export const WSF_FILTER_TYPES: readonly WsfStructType[] = [
...
export const WSF_FOV_TYPES: readonly WsfStructType[] = [
...
export const WSF_PROPAGATION_TYPES: readonly WsfStructType[] = [
...
export const WSF_ATTENUATION_TYPES: readonly WsfStructType[] = [
...
// ---------------------------------------------------------------------------
// Lookup: component keyword → available types
// ---------------------------------------------------------------------------

export type ComponentKeyword =
  | "sensor"
  | "processor"
  | "mover"
  | "comm"
...
const COMPONENT_TYPES: Record<ComponentKeyword, readonly WsfStructType[]> = {
 ...
 */
export function getTypesForComponent(keyword: ComponentKeyword): readonly WsfStructType[] {
