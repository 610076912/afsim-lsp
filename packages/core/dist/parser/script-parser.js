...
export class ScriptParser extends CstParser {
    ...
    scriptBody = this.RULE("scriptBody", () => {
        this.MANY(() => {
            this.SUBRULE(this.statement);
        });
    });
    /** Parse function definitions */
    scriptFuncDefs = this.RULE("scriptFuncDefs", () => {
        this.MANY(() => {
    ...
    formalParamList = this.RULE("formalParamList", () => {
        this.CONSUME(LParen);
        this.OPTION(() => {
    ...
    foreachStatement = this.RULE("foreachStatement", () => {
    ...
    externStatement = this.RULE("externStatement", () => {
    ...
    varDeclStatement = this.RULE("varDeclStatement", () => {
    ...
    eqExpression = this.RULE("eqExpression", () => {
    ...
    cmpExpression = this.RULE("cmpExpression", () => {
    ...
    mulExpression = this.RULE("mulExpression", () => {
    ...
    initializerEntry = this.RULE("initializerEntry", () => {
...
// Singleton
let _scriptParserInstance = null;
