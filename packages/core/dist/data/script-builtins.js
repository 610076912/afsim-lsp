...
// ---------------------------------------------------------------------------
export const SCRIPT_TYPE_KEYWORDS = [
...
// ---------------------------------------------------------------------------
export const SCRIPT_MODIFIER_KEYWORDS = [
    "global", "static", "extern",
];
// ---------------------------------------------------------------------------
// Script literal keywords
// ---------------------------------------------------------------------------
export const SCRIPT_LITERAL_KEYWORDS = [
    "true", "false", "null", "NULL",
];
// ---------------------------------------------------------------------------
// All script class names (from documentation/docs/script/*.rst)
// ---------------------------------------------------------------------------
export const ALL_SCRIPT_CLASSES = [
    // Core language types
...
// ---------------------------------------------------------------------------
export const SCRIPT_CLASS_DEFINITIONS = [
    {
        name: "WsfPlatform",
        baseClass: "WsfObject",
 ...
 */
export function getSystemVariablesForContext(contextType) {
    return SYSTEM_VARIABLES.filter(v => !v.contexts || (contextType && v.contexts.includes(contextType)));
}
//# sourceMappingURL=script-builtins.js.map